...
class DeepSort(object):
    ...
    def update(self, ori_img):
        ...
        results ,features = self.detector.predict(ori_img, self.threshold)
        if results is None:
            return None
        else:
        ...
        for track in self.tracker.tracks:
            ...
            #arr = np.array([x1,y1,x2,y2,track_id],dtype=int)
            list1 = [x1,y1,x2,y2,bbl,bbt,bbw,bbh,track_id,confidence]
